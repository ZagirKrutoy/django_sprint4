# Generated by Django 3.2.16 on 2025-03-22 17:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.category', verbose_name='Категроия'),
        ),
        migrations.AlterField(
            model_name='post',
            name='created_at',
        ...
        migrations.AlterField(
            model_name='post',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.location', verbose_name='Местополжение'),
        ),
        migrations.AlterField(
            model_name='post',
            name='pub_date',
